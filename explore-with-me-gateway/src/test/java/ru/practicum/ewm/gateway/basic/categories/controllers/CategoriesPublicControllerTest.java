...
@WebMvcTest(controllers = CategoriesPublicController.class)
@Import(SecurityConfig.class)
class CategoriesPublicControllerTest {
    ...
    @SneakyThrows
    @WithAnonymousUser
    void getCategories_whenAnonymous_thenOk() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    void getCategoryById_whenAnonymous_thenOk() {
