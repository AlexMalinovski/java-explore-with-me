...
public class RequestPrivateController {
     ...
     */
    @PostMapping
    ResponseEntity<ParticipationRequestDto> createParticipation(
     ...
     */
    @GetMapping
    ResponseEntity<List<ParticipationRequestDto>> getParticipation(@PathVariable long userId) {
    ...
    ResponseEntity<ParticipationRequestDto> cancelParticipation(@PathVariable long userId, @PathVariable long requestId) {
