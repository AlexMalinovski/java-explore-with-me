...
INSERT INTO users (id, name, email, email_lower) VALUES
(1, 'user1', 'owner@mail.ru', 'owner@mail.ru'),
(2, 'user2', 'requester2@mail.ru', 'requester2@mail.ru'),
(3, 'user3', 'requester3@mail.ru', 'requester3@mail.ru');
